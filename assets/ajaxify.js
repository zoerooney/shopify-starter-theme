...
Shopify.onError = function(XMLHttpRequest, textStatus) {
  ...
  /* product is sold out */
  jQ("#cart-updated").html("<a href='#'>Unfortunately, <span class='error-message-text'>"+ data.description  +"</span> Please try a lower quantity.</a>").fadeIn(200).delay(4000).fadeOut(800);;
...
Shopify.onCartUpdate = function(cart, form) {
    ...
    jQ('#cart-updated').html("<h4><a href='/cart'>added to cart</a></h4>").fadeIn(200).delay(2000).fadeOut(800);
